...
The {\it R} language has several implementations of the OO paradigm but,
...
-   <b>Covariates</b> A table of ten rows and four columns containing
    ...
    {Genes} Information about the features contained in the data. May be
...
# The "Gene Expression Omnibus" (GEO) database and the the `GEOquery` package

## Getting data from GEO. The `GEOquery` package.
